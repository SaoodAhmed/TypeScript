...
// console.log(var2);
var HomeGrossary;
(function (HomeGrossary) {
    HomeGrossary[HomeGrossary["apples"] = 2] = "apples";
    HomeGrossary[HomeGrossary["banana"] = 3] = "banana";
    HomeGrossary[HomeGrossary["potatoes"] = 4] = "potatoes";
    HomeGrossary[HomeGrossary["shoes"] = 5] = "shoes";
    HomeGrossary[HomeGrossary["socks"] = 5] = "socks";
})(HomeGrossary || (HomeGrossary = {}));
console.log(HomeGrossary);
let gross1 = HomeGrossary.banana;
console.log(gross1);
let gross2;
