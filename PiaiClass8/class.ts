...
let add:Calculator = new Calculator();  // Default constructor
add.x = 20,
add.y = 30;
...
class Car{
    ...
    constructor(Crname:string,Crmake:string, Crcolor:string, Crmodel:string){
        this.name = Crname;
        this.make = Crmake;
        this.color = Crcolor;
        this.speed = 0;
...
const Mehran:Car = new Car("Mehran","Toyota", "black", "2023");
let Civic:Car = new Car("Civic","Honda","black","2020");
...
class Fan{    
    ...
    constructor(make:string, angularSpeed:number, color:string, price:number){
        this.make = make;
...
let pakFan:Fan = new Fan("PAKFAN",0,"white",2400);
